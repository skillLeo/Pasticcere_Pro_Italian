...
<img src="{{ config('app.url') }}/assets/images/asset/logo.jpg" alt="Pasticcere Pro" width="150" style="display: block; border-radius: 8px;">
                    ...
                    <tr>
                        <td style="font-size: 16px; color: #33475b; line-height: 1.5; padding-bottom: 32px;">
                            Has recibido este correo electrónico porque hemos recibido una solicitud de restablecimiento de contraseña para tu cuenta.
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="font-size: 14px; color: #6b7280; line-height: 1.4; padding-bottom: 40px;">
                            Si no has solicitado el restablecimiento de la contraseña, no es necesario realizar ninguna acción.
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: 16px; color: #33475b; line-height: 1.5; padding-bottom: 32px;">
                    ...
                    <tr>
                        <td style="font-size: 12px; color: #9ca3af; line-height: 1.3; border-top: 1px solid #e5e7eb; padding-top: 24px;">
                            Si tienes dificultades para hacer clic en el botón "Restablecer contraseña", copia y pega la siguiente URL en tu navegador:<br>
                ...
                <p style="font-size: 12px; color: #9ca3af; margin-top: 20px;">© 2025 Pasticcere Pro. Todos los derechos reservados.</p>
            </td>
        </tr>
    </table>
</body>
