    ...
    fetch(`/showcase/getTemplate/${id}`)
      ...
      .then(data => {
        ...
        (data.details || []).forEach(detail => {
          ...
          r.querySelector('.qty-field').value     = detail.quantity ?? 0;
          r.querySelector('.sold-field').value    = 0;
          r.querySelector('.reuse-field').value   = 0;
          r.querySelector('.waste-field').value   = 0;
